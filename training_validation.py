...
from utils import *
from torch_geometric import loader  # 替换原来的导入
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        train_loader = loader.DataLoader(train_data, batch_size=TRAIN_BATCH_SIZE, shuffle=True)
        valid_loader = loader.DataLoader(valid_data, batch_size=TEST_BATCH_SIZE, shuffle=False)
        ...
        model_file_name = 'model_' + model_st + '_' + dataset + '_' + timestamp + '.model'
        result_file_name = 'result_' + model_st + '_' + dataset + '_' + timestamp + '.csv'
